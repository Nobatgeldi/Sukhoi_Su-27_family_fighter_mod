...
while {(alive _this) and (_this animationPhase "KillFx" == 0)} do
	{
		...
		_leftwingemitter setParticleParams [["\ca\Data\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0],"","Billboard",1,1.5,_VectorL,(velocity _this),1,1.275,1,0.1,[0.5,0.7],[[1,1,1,0.01*_opacity],[1,1,1,0.2*_opacity],[1,1,1,0]],[0],0.01,0.01,"","",_this];
		_rightwingemitter setParticleParams [["\ca\Data\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0],"","Billboard",1,1.5,_VectorR,(velocity _this),1,1.275,1,0.1,[0.5,0.7],[[1,1,1,0.01*_opacity],[1,1,1,0.2*_opacity],[1,1,1,0]],[0],0.01,0.01,"","",_this];
