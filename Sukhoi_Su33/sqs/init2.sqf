...
if(isNil 'BIS_Effects_Init') then
	...
	BIS_Effects_Burn=compile preprocessFileLineNumbers "\Sukhoi_Su33\sqs\burn.sqf";
	BIS_Effects_AircraftVapour=compile preprocessFileLineNumbers "\Sukhoi_Su33\sqs\aircraftvapour.sqf";
	BIS_Effects_AirDestruction=compile preprocessFileLineNumbers "\Sukhoi_Su33\sqs\AirDestruction.sqf";
	BIS_Effects_AirDestructionStage2=compile preprocessFileLineNumbers "\Sukhoi_Su33\sqs\AirDestructionStage2.sqf";
	BIS_Effects_Secondaries=compile preprocessFileLineNumbers "\Sukhoi_Su33\sqs\Secondaries.sqf";
