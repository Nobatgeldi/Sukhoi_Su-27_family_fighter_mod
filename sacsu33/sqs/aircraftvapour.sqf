	...
	*/
	...
	//_intensity=3;
	  ...
	  if (_intensity>0.3) then
		...
		_trail1 setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d", 16, 13, 3, 0],
		...
		_trail2 setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d", 16, 13, 3, 0],
		"", "Billboard", 1, 0.6*_intensity,
		[0,0,0], velocity _v,
		0, 1, 0.79, 0.18,
