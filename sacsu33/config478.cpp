...
class CfgVehicles
{
	...
	class SACSu33: Plane
	{
		...
		class EventHandlers
		{
			init="_this execVM ""\a3\data_f\ParticleEffects\SCRIPTS\init.sqf"",[_this select 0]exec ""\SACSu33\sqs\init.sqs"",[_this select 0]exec ""\SACSu33\sqs\wing.sqs"",[_this select 0] execVM ""\SACSu33\sqs\AircraftEffects.sqf"",_this execVM ""a3\data_F\ParticleEffects\SCRIPTS\misc\aircraftvapour.sqf""";
